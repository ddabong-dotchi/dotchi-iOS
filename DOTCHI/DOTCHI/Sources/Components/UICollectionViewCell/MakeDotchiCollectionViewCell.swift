//
//  MakeDotchiCollectionViewCell.swift
//  DOTCHI
//
...
final class MakeDotchiCollectionViewCell: UICollectionViewCell {
    ...
    private let loadPhotoView: LoadPhotoView = LoadPhotoView()
...
extension MakeDotchiCollectionViewCell {
